...
$photographerID = isset($_GET['photographer_id']) ? $_GET['photographer_id'] : null;

// Query to fetch customer name
...
// Query to fetch photographer name and other details
$photographerQuery = "SELECT * FROM photographers WHERE PhotographerID = $photographerID";
$photographerResult = mysqli_query($conn, $photographerQuery);
$photographer = ($row = mysqli_fetch_assoc($photographerResult)) ? $row : null;
...
// Query to fetch photographer's available places
    ...
    <form action="bookingstore.php" method="post" class="form-outline" enctype="multipart/form-data" onsubmit="return confirmBooking();">
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text"  class="form-control" value="<?php echo $photographer['Name']; ?>" readonly>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group">
