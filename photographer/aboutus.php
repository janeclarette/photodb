...
<body>
    ...
    <nav class="sub-navbar">
        <ul>
            <!-- Navigation links -->
            <li><a href="/photodb/photographer/phdashboard.php">Home</a></li>       
            <li><a href="/photodb/photographer/work_create.php">Portfolio</a></li>
            <li><a href="/photodb/photographer/schedule.php">Schedule</a></li>
            <li><a href="/photodb/photographer/gallery.php">Gallery</a></li>
            <li><a href="/photodb/photographer/package.php">Package</a></li>
            <li><a href="/photodb/photographer/place.php">Place</a></li>
            <li><a href="/photodb/photographer/reviews.php">Reviews</a></li>
            <li><a href="/photodb/photographer/aboutus.php">About Us</a></li>
        </ul>
    </nav>
